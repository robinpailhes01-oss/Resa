...
export function Hero() {
  ...
  return (
    <section id="hero" aria-labelledby="hero-title" className="reso-hero relative isolate overflow-x-clip pb-10 pt-9 md:pb-16 md:pt-14">
      ...
      <div className="container-page">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          <p className="hero-eyebrow enter mb-4 text-[13px] font-medium text-brand md:mb-6 md:text-[15px]" style={d(0)}>
            {hero.eyebrow}
          </p>
          ...
          <p className="hero-intro-mobile enter mt-5 max-w-[310px] text-[15px] leading-[23px] text-ink-muted md:hidden" style={d(200)}>
            {hero.introShort}
          </p>
          ...
          <div className="hero-price enter mt-3" style={d(300)}>
          ...
          <div className="hero-actions enter mt-5 flex w-full max-w-[320px] flex-col gap-3 sm:w-auto sm:max-w-none sm:flex-row sm:items-center sm:gap-4 md:mt-6" style={d(380)}>
        ...
        <figure id="apercu" className="hero-figure enter relative mx-auto mt-12 max-w-[1040px] md:mt-14" style={d(360)}>
          ...
          <figcaption className="hero-caption mx-auto mt-7 flex max-w-xs items-center gap-4 text-[12px] text-ink-muted">
