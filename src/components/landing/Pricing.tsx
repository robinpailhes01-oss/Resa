...
export function Pricing() {
  ...
  return (
    <Section id="tarif" labelledBy="tarif-title" tone="page" className="!pt-2 !pb-10 md:!pt-4 md:!pb-14">
      <div
        id="tarif-card"
        className="pricing-panel reveal mx-auto rounded-[24px] px-5 py-7 md:px-9 md:py-10"
      >
        <div className="grid gap-5 lg:grid-cols-[1.05fr_1fr_1.15fr] lg:items-center lg:gap-7">
          ...
          <div className="text-center lg:border-x lg:border-soft lg:px-3">
            ...
            <p className="mt-1 text-[12px] text-ink-muted">{pricing.scope}</p>
          </div>

          <div className="flex flex-col items-center lg:items-start">
            <ul className="space-y-2 border-t border-soft pt-5 lg:border-0 lg:pt-0">
      ...
      <ul className="mx-auto mt-4 flex max-w-4xl flex-col gap-1 text-center text-[12px] leading-5 text-ink-muted">
