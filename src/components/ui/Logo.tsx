...
/**
 * Logotype des maquettes : symbole lavande et mot « reso » noir, sans point.
...
export function Logo({ height = 28, tone = "brand", className, title = "Reso" }: LogoProps) {
  ...
  return (
    <svg
      ...
      fill="currentColor"
    >
      <rect x="0" y="3" width="26" height="26" rx="8" fill={tone === "white" ? "#ffffff" : "#a699ff"} />
      <path d="M2 29C3 16 11 6 26 3V18C26 24.1 21.1 29 15 29Z" fill={tone === "white" ? "#ded7ff" : "#8064f4"} />
